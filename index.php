...
<body>
  ...
  $menuLinks=['Overview','Privacy Policy','Terms of Service','FAQ'];
  $faqs=[
    [
  ...
  <header>
    <div class="top-header">
      <div class="left">
        <img src="https://seomofo.com/logos/google-logo.png" alt="">
        <h4>Privacy & Terms</h4>
      </div>
      <div class="right">
        <i class="fas fa-bars"></i>
        <img src="https://image.freepik.com/free-vector/businessman-character-avatar-isolated_24877-60111.jpg" alt="">
      </div>
    </div>
    <div class="bottom">
      <ul>
